...
CREATE TABLE `t_cpu_mark`  (
  ...
  `clockspeed` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '时钟频率',
  `turbo_speed` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '最大睿频时钟频率',
  `typical_tdp` int(11) NULL DEFAULT NULL COMMENT '典型的TDP（单位：W）',
  `socket` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '插座',
  `physical_cores` int(11) NULL DEFAULT NULL COMMENT '物理核心数（单位：个）',
  `logical_cores_per_physical` int(11) NULL DEFAULT NULL COMMENT '每个物理2个逻辑核心（单位：个）',
  ...
  `single_thread_rating` int(11) NULL DEFAULT NULL COMMENT '单线程',
  `samples` bigint(20) NULL DEFAULT NULL COMMENT '样本',
  `error_margin` bigint(20) NULL DEFAULT NULL COMMENT '误差幅度',
  `cpu_first_seen_on _charts` datetime(0) NULL DEFAULT NULL COMMENT '首次上市时间（例子：Q2 2017）',
  `create_date` datetime(0) NULL DEFAULT NULL COMMENT '测试日期',
  `update_date` timestamp(0) NULL DEFAULT NULL COMMENT '更新日期',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'cpu分数信息记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_sys_log`  (
  ...
  `create_date` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '记录创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `t_sys_personal_address` VALUES (1, '王三元', '18107200666', '湖北省 十堰市 茅箭区', '五堰街道和昌国际城二期C49-2702', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '家', '最近一次用的地址');
INSERT INTO `t_sys_personal_address` VALUES (2, '叶钰薇', NULL, '浙江省 台州市 玉环市', '玉环县汽摩工业园区 金泰机械锻造有限公司（收发室代收）', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_sys_personal_address` VALUES (3, NULL, NULL, '上海市 浦东新区', '杨高南路秀沿西路  绿地香颂附近（中国电信园区对面）', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_sys_personal_address` VALUES (4, '中国电信园区', NULL, '上海市 浦东新区', '杨高南路5678号中国电信园区（北门）', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_sys_personal_address` VALUES (5, NULL, NULL, '上海市 浦东新区', '宏雅路151弄保集澜湾一期34号701室', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_sys_personal_address` VALUES (6, '易联互动网络信息技术', NULL, '上海市 浦东新区', '易联互动网络信息技术（北京）有限公司  上海分部', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_sys_personal_address` VALUES (7, '叶超', NULL, '上海市 浦东新区', '张江高科技园区纳贤路60号腾飞莲花商务园上海优读信息科技有限公司 5202C', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_sys_personal_address` VALUES (8, NULL, NULL, '上海市 浦东新区', '唐镇·宏雅路151号 保集澜湾一期34号 701 （工作日不在家，请放在快递柜子或者物业，谢谢）', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_sys_personal_address` VALUES (9, NULL, NULL, '上海市 浦东新区', '张江镇·川杨新苑6期 43栋601', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_sys_personal_address` VALUES (10, NULL, NULL, '上海市 普陀区 ', '桃浦·桃浦新家园74号 302室 银杏路 60弄 1-99', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_sys_personal_address` VALUES (11, NULL, NULL, '上海市 浦东新区', '张江高科技园区·盛夏路500号星峰企业园 7号楼 容易网 （放前台 谢谢）', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_sys_personal_address` VALUES (12, NULL, NULL, '上海市 杨浦区 ', '殷行街道·包头路280号 207室', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_sys_personal_address` VALUES (13, NULL, NULL, '上海市 浦东新区', '康桥镇·秀沿西路218弄 绿地·香颂 165 401（放蜂巢就可以）', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_sys_personal_address` VALUES (14, NULL, NULL, '上海市 浦东新区', '川沙新镇·途趣国际青年旅舍', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_sys_personal_address` VALUES (15, NULL, NULL, '广东省 广州市 天河区 ', '棠下街道·棠下村 大片路 禾尾西一巷4号106', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_sys_personal_address` VALUES (16, '汪章凯', NULL, '湖北省 武汉市 黄陂区 ', '横店街道·武汉圆通总部IT部 027-83063058 请打固话', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `t_sys_resource`  (
  ...
  `update_date` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_sys_user_auth`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户授权信息表 ' ROW_FORMAT = Dynamic;
